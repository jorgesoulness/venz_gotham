...
namespace Cookiez\Modules\Settings\Banners;
...
class Elementor_Birthday_Banner {
	const BANNER_POINTER_NAME = 'cookiez_birthday_sale_banner';
	const POINTER_ACTION = 'cookiez_pointer_dismissed';
	const POINTER_NONCE_KEY = 'cookiez-pointer-dismissed';
	...
	public static function get_banner( string $link ) {
		...
		?>
		<div class="elementor-birthday-banner" role="region" aria-label="<?php esc_attr_e( 'Elementor birthday sale', 'cookiez' ); ?>">
			<div class="elementor-birthday-banner-container">
				<p><span><?php esc_html_e( 'Celebrate Elementor’s 10th birthday', 'cookiez' ); ?></span> | <?php esc_html_e( 'Up to 30% off', 'cookiez' ); ?></p>
				<a href="<?php echo esc_url( $link ); ?>" target="_blank"><?php esc_html_e( 'Get discounts', 'cookiez' ); ?></a>
			</div>
			<button type="button" aria-label="<?php esc_attr_e( 'Dismiss', 'cookiez' ); ?>">
