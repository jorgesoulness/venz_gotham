...
class Preferences_Heading extends Widget_Base {

	public function get_name(): string {
		return 'cookiez-preferences-heading';
	}

	public function get_title(): string {
		return esc_html__( 'Preferences Heading', 'cookiez' );
	}
	...
	public function get_keywords(): array {
		return [ 'cookie', 'consent', 'preferences', 'heading' ];
	}
	...
	protected function render(): void {
		$content = Content_Resolver::get_active_preferences_fields(
		...
		<div class="cookiez-heading">
			...
			<<?php echo esc_attr( $header_size ); ?> id="cookiez-title" class="cookiez-heading__text">
				<?php echo wp_kses_post( $content['header'] ); ?>
