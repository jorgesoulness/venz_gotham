...
namespace Cookiez\Modules\Connect;
...
class Module extends Module_Base {
	...
	public function authorize_url( $authorize_url ) {
		...
		$sm_campaign = get_transient( 'elementor_cookiez_campaign' );
	...
	public function __construct() {
		add_filter( 'elementor_one/cookiez_connect_authorize_url', [ $this, 'authorize_url' ] );
